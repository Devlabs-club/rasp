...
const ArrayInput = ({label, name, placeholder, items, setItems}) => {
  ...
  return (
    <div className='flex flex-col gap-2'>
        ...
        <div className="bg-neutral-800 px-5 py-3 text-neutral-200 flex flex-wrap gap-2 rounded-md">
            ...
            <input type="text" autoComplete="off" id={name} name={name} placeholder={!items.length ? placeholder : "..."} value={value} className='text-neutral-200 outline-none bg-neutral-800 flex-grow' onChange={(e) => setValue(e.target.value)} onKeyDown={onKeyDown} />
